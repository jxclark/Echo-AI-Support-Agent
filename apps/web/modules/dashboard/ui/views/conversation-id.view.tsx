...
export const ConversationIdView = ({
  ...
  const handleToggleStatus = async () => {
    ...
    // Cycle through states: unresolved -> escalated  -> resolved -> resolved
            ...
            <FormField
              ...
              render={({ field }) => (
                <AIInputTextarea
                  ...
                  placeholder={
                    conversation?.status === "resolved"
                      ? "This conversation has been resolvedd"
      ...
      <AIConversation className="max-h-[calc(100vh-180px)]">
        <AIConversationContent>
          {Array.from({ length: 8 }, (_, index) => {
            const isUser = index % 2 === 0; // Alternate between user and assistant
