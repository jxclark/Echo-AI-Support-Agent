...
export const ContactPanel = () => {
  ...
  const countryInfo = useMemo(() => {
    return getCountryFromeTimezone(contactSession?.metadata?.timezone);
  ...
  return (
    <div className="flex h-full w-full flex-col bg-background text-foreground">
      <div className="flex flex-col gapy-4 p-4">
      ...
      <EmailDialog
        ...
        recipientEmail={contactSession.email}
        recipientName={contactSession.name}
      />
    </div>
  );
};
