...
export async function POST(request: NextRequest) {
  try {
    ...
    const contactSession = await convex.query(api.private.contactSessions.getOneByConversationId, {
    ...
    console.log('Sending email:', { from: fromEmail, to: recipientEmail, subject });
